...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="location_url" value="<?= $row->location_url ?>" placeholder="<?= $this->language->create_biolink_tidal_modal->input->location_url_placeholder ?>" required="required" />
    </div>
