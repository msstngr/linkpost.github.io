            ...
            <div class="modal-body">
                <form name="create_biolink_twitch" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="location_url" required="required" placeholder="<?= language()->create_biolink_twitch_modal->input->location_url_placeholder ?>" />
                    </div>
