                ...
                <div class="col">
                    ...
                    <div id="plan_settings" style="display: none">
                        ...
                        <div class="custom-control custom-switch mb-3">
                            ...
                            <label class="custom-control-label" for="google_analytics"><?= language()->admin_plans->plan->google_analytics ?></label>
                            <div><small class="form-text text-muted"><?= language()->admin_plans->plan->google_analytics_help ?></small></div>
                        </div>
                        ...
                        <div class="custom-control custom-switch mb-3">
                            ...
                            <label class="custom-control-label" for="facebook_pixel"><?= language()->admin_plans->plan->facebook_pixel ?></label>
                            <div><small class="form-text text-muted"><?= language()->admin_plans->plan->facebook_pixel_help ?></small></div>
                        </div>
                        ...
                        <div class="custom-control custom-switch mb-3">
                            ...
                            <label class="custom-control-label" for="scheduling"><?= language()->admin_plans->plan->scheduling ?></label>
                            <div><small class="form-text text-muted"><?= language()->admin_plans->plan->scheduling_help ?></small></div>
                        </div>
                            ...
                            <?php foreach(require APP_PATH . 'includes/biolink_blocks.php' as $biolink_block): ?>
                                <div class="col-6 mb-3">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label" for="enabled_biolink_blocks_<?= $biolink_block ?>"><?= language()->link->biolink->{strtolower($biolink_block)}->name ?></label>
                                    </div>
                                </div>
                            <?php endforeach ?>
                        </div>
